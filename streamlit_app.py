...
tab3.markdown('######')
tab3.markdown('######')
tab3.subheader("Number of Points by Filter")
tab3_col1, tab3_col2, tab3_col3 = tab3.columns(3)
tab3_col1.dataframe(filter_results_df, height=597)
...
tab3.divider()
tab3_col1, tab3_col2, tab3_col3 = tab3.columns(3)
tab3_col1.subheader("Regression Coefficients")

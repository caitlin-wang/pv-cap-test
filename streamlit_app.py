...
fig = go.Figure()
fig.add_trace(go.Scatter(x=merged_df['t_stamp'], y=merged_df['inverter_clipping_check'], mode='lines', name=col))
fig.add_trace(go.Scatter(x=merged_df['t_stamp'], y=merged_df['inverter_blank'], mode='lines', name=col))
fig.add_trace(go.Scatter(x=merged_df['t_stamp'], y=merged_df['inverter_zero'], mode='lines', name=col))

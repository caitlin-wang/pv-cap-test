...
#tab3.write(soiling_data) # soiling by day not working
tab3.write("")
...
tab3_col2.dataframe(count_primary_filters_per_day, width=300)
tab3_col3.write("Secondary filters per day:")
tab3_col3.dataframe(count_secondary_filters_per_day, width=300)

...
test_start_date = datetime.combine(form1_col1.date_input("Start Date", 'today', format='MM/DD/YYYY'), datetime.min.time())
test_end_date = datetime.combine(form1_col2.date_input("End Date", 'today', format='MM/DD/YYYY'), datetime.min.time())
